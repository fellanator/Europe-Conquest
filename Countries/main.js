  ...
  enemyCountries.forEach((country) =>{
    ...
    Object.keys(countryChoice.Stats.Cities).forEach(city =>{
        ...
        if(countryChoice.Stats.Cities[city].Capital == true)
        {
            ...
            towers.push(countryChoice.Stats.Cities[city].Tower);
            farms.push(countryChoice.Stats.Cities[city].Farm);
            bases.push(countryChoice.Stats.Cities[city].Base);
...
const buildInterval = setInterval(() =>{
 ...
 console.log( baseCountry.Stats.Cities[city].Military);
...
{
     baseCountry.Stats.Cities[city].Supplies += baseCountry.Stats.Cities[city].Population/100;
}
